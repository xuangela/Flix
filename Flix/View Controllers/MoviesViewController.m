...
- (void)viewDidLoad {
    ...
    self.alert = [UIAlertController alertControllerWithTitle:@"Connot Get Movies" message:@"The internet connection appears to be offline." preferredStyle:(UIAlertControllerStyleAlert)];
